...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 10
        validate_formals(expressions.first.rest)
        env.define(signature.first, LambdaProcedure(expressions.first.rest, expressions.rest, env))
...
def do_and_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        if evaluated is nil or evaluated is False:
            return False
